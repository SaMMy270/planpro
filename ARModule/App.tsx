...
const PRODUCTS: ProductData[] = (rPRODUCTS as unknown as ProductData[]);
// Sub-components
...
const App: React.FC = () => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return PRODUCTS.filter((p: ProductData) => {
      ...
      const subcategory = p.SubType?.toLowerCase() || "";
  ...
  const triggerSmartCompare = (product: Product) => {
    setSelectedProduct(product);
    setActiveTab('comparison');
  };
